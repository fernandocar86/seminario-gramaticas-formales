...
tk_symfont_name('-adobe-symbol-medium-r-normal--18-180-*').
tk_font_name('-*-times-bold-r-normal--18-180-*').
tk_geometry('wm geometry . 575x475-5-3').

label_size(Label, PixWidth, 18) :- 
%	format_to_chars("~p", [Label], LabelChars),
	sformat(LabelString,'~p',[Label]), string_to_list(LabelString,LabelChars),
	chars_width(LabelChars, 0, Width0, tbr18),
...
char_width(tbr18, C, Width) :- tbr12(C, Width0), Width is Width0*100000*(1.5).
