...
#    print()
    print('  d muestra el árbol de derivación')
    print('  s para el state tree')
    print('  b para el árbol sin etiquetas')
    print('  x para un árbol de x con barra')
    print('  l muestra la gramática como un árbol')
    print('  n para probar con otra oración')
    print('  ; para buscar otro parseo alternativo')    #added EA
    print('  q or just return: para salir')
    print()
    print('or for line mode interaction:')
    print('  pd para un árbol bonito')
    print('  ps para un árbol bonito de estado')
    print('  pb para un árbol bonito sin etiquetas')
    print('  px para un árbol bonito X con barra')
    print('  pl para dibujar bonitamente la gramática como árbol')
    print('  pg imprime la gramática como una lista de items')
    print()
